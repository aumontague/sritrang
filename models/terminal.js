...
class terminal {
    ...
    terminalList(req, dataPost, _) {
        return new Promise((resolve, reject) => {
            var _query = 'SELECT * FROM Terminal'
    ...
    terminalInsert(req, dataPost, _) {
        return new Promise((resolve, reject) => {
            var _query = 'INSERT INTO Terminal(TerminalId, TerminalName, TerminalNo, CountryId, Status, CreateId, CreateDate) VALUES (?,?,?,?,?,?,?)'
    ...
    terminalUpdate(req, dataPost, _) {
        return new Promise((resolve, reject) => {
            var _query = 'UPDATE Terminal SET TerminalName = ?, TerminalNo = ?, CountryId = ?, Status = ?, ModID = ?, ModDate = ? WHERE TerminalId = ?'
            var value = [
